...
export const getParallelSession = () => api.get(url.GET_PARALLEL_SESSION);
...
export const addParallelSession = (parallel) =>
  api.create(url.ADD_PARALLEL_SESSION, parallel);
...
export const getSessions = () => api.get(url.GET_SESSIONS);

// add Tickets
export const addNewTicket = (ticket) => api.create(url.ADD_NEW_TICKET, ticket);

export const addSession = (session) => api.create(url.ADD_SESSION, session);
...
export const getSpeakers = () => api.get(url.GET_SPEAKERS);
...
export const addSpeakers = (speakers) =>
  api.create(url.ADD_SPEAKERS, speakers, {
