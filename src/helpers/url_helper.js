...
export const POST_CHECKIN_USER = "/user/checkin";
...
export const GET_SESSIONS = "/sessions/session";
export const ADD_NEW_TICKET = "/apps/ticket";
export const ADD_SESSION = "/sessions/create-session";
...
// Pages > Team
export const GET_TEAMDATA = "/get/teamData";
export const GET_SPEAKERS = "/speakers/speakers";
export const DELETE_TEAMDATA = "/delete/teamData";
export const ADD_NEW_TEAMDATA = "/add/teamData";
export const ADD_SPEAKERS = "/speakers/create-speaker";
